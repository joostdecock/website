                ...
                >
                  <div className="overpad2-always">
                    <SettingsPicker
                      ...
                      showDocs={this.showDocs}
                      docs={this.state.docs}
                      options={patternInfo[this.state.pattern].optionGroups}
                      optionConfig={
                        patternInfo[this.state.pattern].config.options
                      }
                      optionValues={this.state.settings.options}
                    />
                  </div>
                </Tray>
                <Tray
                  className="mb1"
                  icon={<TuneIcon />}
                  title={<FormattedMessage id="app.draftOptions" />}
                >
                  <div className="overpad2-always">
                    <SettingsPicker
                      pattern={patternInfo[this.state.pattern]}
                      ...
                      optionValues={draftOptions.values}
                    />
                  </div>
                </Tray>
              </div>
